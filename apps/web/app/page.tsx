    ...
    <div className="min-h-dvh w-full flex flex-col items-center justify-start gap-10 p-4 md:p-8 relative overflow-hidden bg-black text-white">
      ...
      <div className="w-full max-w-6xl flex flex-col gap-8 relative z-10">
        <Card className="border-0 bg-white/[0.03] backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden ring-1 ring-white/10 transition-all hover:ring-white/20">
          <CardHeader className="space-y-4 p-8 md:p-10 pb-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-gray-100 text-3xl md:text-4xl font-extrabold tracking-tight">
                Hii <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400 drop-shadow-sm">{name || 'Guest'}</span>-san, welcome to Nihongo Jav!
              </CardTitle>
            </div>
          </CardHeader>
          ...
          <CardContent className="flex flex-col lg:flex-row gap-10 p-8 md:p-10 pt-2 items-center">
            <div className="text-base md:text-lg leading-relaxed text-gray-300 flex-1 space-y-6">
              <p>
                Jav Nihongo is the <span className="text-pink-400 font-semibold px-1 bg-pink-500/10 rounded-md">adult</span> way of learning <span className="text-pink-400 font-semibold px-1 bg-pink-500/10 rounded-md">Japanese</span>. Where Japanese learning meets a bold, grown-up vibe. No kiddie cartoons, no boring worksheets—just clean explanations, memorable examples, and a style made for adults who want their study time to feel… a little more <span className="text-pink-400 font-semibold underline decoration-pink-500/50 decoration-2 underline-offset-4">exciting</span>.
              </p>
              <p>
                Here, you’ll explore the language in a way that’s <span className="text-white font-medium">fun, modern</span>, and just a bit seductive—because learning should feel good, not stressful. Each lesson guides you step by step, mixing real-world Japanese with playful humor and practical context.
              </p>
              <p>
                Whether you’re exploring your first kana or leveling up your conversation game, Jav Nihongo keeps things <span className="text-pink-400 font-semibold italic">smooth, mature,</span> and seriously enjoyable. Learn at your pace. Savor each lesson. And enjoy the journey.
              </p>
            </div>
            ...
            <div className="relative w-full lg:w-[400px] shrink-0 group">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-md rounded-2xl p-4 border border-white/10 flex items-center gap-3 z-20">
                ...
                <div>
                  <div className="text-sm font-bold text-white">Ready to start?</div>
                  <div className="text-xs text-gray-400">Jump right into the lessons below</div>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="flex items-center gap-3 mt-4 mb-2">
          ...
          <h2 className="text-2xl font-bold text-white tracking-tight">Select a Lesson</h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-6 relative z-10">
                  ...
                  {touched && (
                    <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-pink-500/20 text-pink-300 text-xs font-bold border border-pink-500/20 shadow-[0_0_10px_rgba(236,72,153,0.2)]" title="In Progress">
